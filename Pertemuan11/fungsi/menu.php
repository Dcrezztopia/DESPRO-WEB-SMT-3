...
<body>
    <div class="sidebar border border-right col-md- col-lg-2 p-0 bg-body-tertiary">
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="sidebarMenuLabel">Aplikasi Kantor Pascalis</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcavas" data-bs-target="sidebarMenu"
